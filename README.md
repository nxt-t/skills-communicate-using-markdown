flowchart LR
    ...
    classDef note_style fill:#f3e5f5,stroke:#6a1b9a,stroke-width:1px,stroke-dasharray:4 4;

    A["<b>生产 / 采购</b><br>📄 生产单<br>💰 成本￥50"]:::china_style
    B["<b>国内运输</b><br>📄 供应商送货单<br>💰 成本￥10"]:::china_style
    C["<b>本地仓</b><br>📄 收货单、质检单（国内）"]:::china_style
    D["<b>头程运输 + 清关</b><br>📄 报关单、提单、头程物流单<br>💰 成本￥10"]:::china_style
    E["<b>海外仓签收入库</b><br>📄 入库单、质检单（海外）"]:::abroad_style
    F["<b>尾程派送</b><br>📄 拣货单、发货单、尾程物流单<br>💰 成本￥10"]:::abroad_style
