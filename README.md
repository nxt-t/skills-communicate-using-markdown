...
flowchart LR
    ...
    C["<b>本地仓操作</b><br>📄 收货单、质检单（国内）"]:::china_style
    ...
    A -->|⏱ 20~60天（自产常规）<br>⏱ 20~30天（快反）<br>⏱ 3~7天（1688现货）| B
    B -->|⏱ 约7天| C
    C -->|⏱ 2~5天| D
    D -->|⏱ 15~35天（海运）| E
    E -->|⏱ 1~2天| F
    ...
    H["<b>📅 全链路总耗时（含尾程）</b><br>常规自产：75~114天<br>快反自产：50~84天<br>1688现货采购：33~61天"]:::note_style
    D -.->|阶段三+四合计 20~40天| H
    F -.->|尾程计入| H
```
